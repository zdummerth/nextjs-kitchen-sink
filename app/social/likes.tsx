    ...
    <>
      ...
      >
        <svg
          ...
          className={`group-hover:fill-cyan-300 group-hover:stroke-cyan-300 ${
            dataState.user_has_liked_tweet
              ? "fill-cyan-300 stroke-cyan-300"
        ...
        <span
          className={`ml-2 text-sm group-hover:text-[#56c8f2] ${
            dataState.user_has_liked_tweet ? "text-[#56c8f2]" : "text-gray-500"
          }`}
        >
          {dataState.likes}
        </span>
